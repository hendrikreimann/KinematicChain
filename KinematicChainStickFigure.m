...
%                         'Xdata', [obj.kinematicChain.jointPositions{i_joint}(1), obj.kinematicChain.jointPositions{i_joint+1}(1)], ...
%                         'Ydata', [obj.kinematicChain.jointPositions{i_joint}(2), obj.kinematicChain.jointPositions{i_joint+1}(2)], ...
%                         'Zdata', [obj.kinematicChain.jointPositions{i_joint}(3), obj.kinematicChain.jointPositions{i_joint+1}(3)]);
%             end
%             set(obj.linkPlots(obj.kinematicChain.numberOfJoints), ...
%                     'Xdata', [obj.kinematicChain.jointPositions{obj.kinematicChain.numberOfJoints}(1), obj.kinematicChain.endEffectorPosition(1)], ...
%                     'Ydata', [obj.kinematicChain.jointPositions{obj.kinematicChain.numberOfJoints}(2), obj.kinematicChain.endEffectorPosition(2)], ...
%                     'Zdata', [obj.kinematicChain.jointPositions{obj.kinematicChain.numberOfJoints}(3), obj.kinematicChain.endEffectorPosition(3)]);
